...
@pytest.mark.asyncio
async def test_list_milestones(client, sample_milestone):
...
@pytest.mark.asyncio
async def test_update_milestone(client, sample_milestone):
...
@pytest.mark.asyncio
async def test_delete_milestone(client, sample_milestone):
    resp = await client.delete(f"/api/v1/milestones/{sample_milestone}")
